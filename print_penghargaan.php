...
// Ambil data dari tabel penghargaan dan pegawai
...
$pdf->SetDrawColor(0, 0, 0); // Warna hitam
$pdf->Line(80, $pdf->GetY(), 130, $pdf->GetY()); // Garis bawah judul Surat Penghargaan
$pdf->Ln(2);

// Nomor surat dengan id_penghargaan
...
// Alasan penghargaan dengan pengaturan spasi 1.25
$pdf->SetFont('Arial', '', 11);
