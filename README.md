...
## Database
Proyek ini menggunakan database dengan nama `db_lat_hrd`. Untuk menjalankan proyek ini, Anda perlu mengimpor file SQL yang telah disediakan ke dalam sistem database Anda. 
